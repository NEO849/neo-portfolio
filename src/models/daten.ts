...
export const PROJEKTE: ProjektModel[] = [
  ...
  },
  {
    ...
    highlights: [
      "Fünfstufiger Aufbau (Core, Deep, Archival, Recall, Staging) hält den Kontext schlank",
      "Drei Hooks erfassen Korrekturen, schreiben Zusammenfassungen und melden offene Einträge automatisch",
      "Eine Auto-Verlinkung erkennt verwandte Notizen und verknüpft sie beidseitig",
      "Das Ergebnis eines Reports aktualisiert das Vertrauen in die zitierten Notizen",
      "Aktive Wiederholung deckt veraltete oder unklare Einträge auf",
      "Ähnliche Einzel-Lektionen werden zu übergeordneten Regeln verdichtet",
      "Jede Empfehlung verweist auf ihre Quelle; täglicher Check und Git-Versionierung sichern alles ab",
    ],
    zeitraum: "2025 – heute",
    status: "aktiv",
  },
...
export const ZEITSTRAHL: ZeitstrahlModel[] = [
  {
    ...
    module: [
      ...
      { name: "Pharma-Serverfarm",     skills: ["Aufbau", "Strukturierte Verkabelung", "Patchen", "LWL-Spleißen"] },
      { name: "DECT-Großsystem · Freistaat Bayern", skills: ["Projektleitung", "Bayerns größtes DECT-System", "München"] },
      { name: "Telekom-Rollouts",      skills: ["Siemens", "Deutsche Telekom", "E.ON Energie", "Telefonanlagen"] },
    ],
  },
  {
    jahr: "2014–2018",
    ...
    module: [
      { name: "Arbeitstherapie",            skills: ["Schwer erziehbare Jugendliche", "Aufnahmegespräche", "Projektarbeit mit Klienten", "Gruppensitzungen"] },
      { name: "Reha-Dokumentation",         skills: ["KTL-Leistungen", "Berichte für die Rentenversicherung"] },
      { name: "Qualität & Arbeitssicherheit", skills: ["QM-Beauftragter (QMB)", "Sicherheitsbeauftragter", "Arbeitsschutz"] },
